	...
	<body>
		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="updateDB.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="regNum" type="text"  placeholder="" value="<?php echo $data['regNum'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="balance" type="text"  placeholder="" value="<?php echo $data['balance'];?>" required>
						</div>
					</div>
